...
\usepackage{tabularx} % For tables that adjust to the page width
\usepackage{graphicx}
\usepackage{caption}
...
\input{chapters/02-theory-biometrics}
\input{chapters/03-s0-theory-gnn}
\input{chapters/03-s1-metrics}
\input{chapters/04-project-idea}
\input{chapters/04-s0-project-use-cases}
\input{chapters/04-s1-project-server}
\input{chapters/04-s2-project-app}
\input{chapters/05-s0-gnn}
\input{chapters/05-s1-gnn-features}
\input{chapters/05-s3-gnn-architecture}
\input{chapters/06-results}
\input{chapters/06-s4-discussion}
...
\bibliographystyle{unsrt}{\raggedright\sloppy\small\bibliography{bibliography}}
