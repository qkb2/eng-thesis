...
\end{itemize}
After processing data \texttt{saveTsvToDownloads} stores data locally, and \texttt{sendTsvToFastApi} sends data to the server. The username, and the relevant phase is included in the file name. \newline
